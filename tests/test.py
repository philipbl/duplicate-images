...
def test_hash_file():
    ...
    assert hash_ == '87d35b107848e5d7963a5d2879d4b4a6c3950a873c7ee11ed2790eba2da2b06d'
...
def test_add():
    ...
    assert db_result['hash'] == '87d35b107848e5d7963a5d2879d4b4a6c3950a873c7ee11ed2790eba2da2b06d'
    assert db.count() > 0
